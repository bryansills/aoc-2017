...
class Day07Test {
    ...
    fun part2samples() {
        ...
        Assert.assertEquals(50, Day07.part2(getResourceAsString("day07sample05.txt")))
        Assert.assertEquals(66, Day07.part2(getResourceAsString("day07sample06.txt")))
        Assert.assertEquals(66, Day07.part2(getResourceAsString("day07sample07.txt")))
    }

//    @Test
//    fun part2() {
//        Assert.assertEquals(-1, Day07.part1(getResourceAsString("day07.txt")))
//    }
}